          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 flex flex-col items-center gap-5">
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-cairo text-gray-500 leading-relaxed">
                ...
                <br />
                سيتم إخفاؤه ولن يظهر للزوار، ويمكن استرجاعه لاحقاً.
              </p>
            </div>
            ...
            <div className="flex gap-3 w-full mt-1">
              ...
              <button
                ...
                disabled={isPending}
                className="flex-1 py-3 rounded-xl bg-red-500 text-white font-tajawal font-bold hover:bg-red-600 active:scale-95 transition-all flex items-center justify-center gap-2 shadow-sm disabled:opacity-70"
              >
                {isPending ? (
